...
export interface ApiOvertimeDeclarationOvertimeDeclaration
  ...
  info: {
    displayName: 'Overtime Declaration';
    pluralName: 'overtime-declarations';
    singularName: 'overtime-declaration';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiProjectTimeAllocationProjectTimeAllocation
  extends Struct.CollectionTypeSchema {
  collectionName: 'project_time_allocations';
  info: {
    displayName: 'Project Time Allocation';
    pluralName: 'project-time-allocations';
    singularName: 'project-time-allocation';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    autoGenerated: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::project-time-allocation.project-time-allocation'
    > &
      Schema.Attribute.Private;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    color: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#0b4a5a'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    estimatedHours: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    expectedEnd: Schema.Attribute.Date;
    expectedStart: Schema.Attribute.Date;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::project.project'
...
export interface ApiSessionSession extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    status: Schema.Attribute.Enumeration<['active', 'break', 'completed']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'active'>;
    totalBreakMinutes: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<
...
export interface ApiTeamStatsTeamStats extends Struct.SingleTypeSchema {
  collectionName: 'team_stats';
  info: {
    displayName: 'Team Stats';
    pluralName: 'team-statistics';
    singularName: 'team-stats';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiWorkspaceWorkspace extends Struct.SingleTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::project-time-allocation.project-time-allocation': ApiProjectTimeAllocationProjectTimeAllocation;
